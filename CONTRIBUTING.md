# Contributing to Concertim Visualisation App

:+1::tada: Thanks for taking the time to contribute! :tada::+1:

You want to contribute to Concertim Visualisation App? Welcome! Please read this
...
You can help Concertim Visualisation App by helping others who use it and need support.

## Analyse Issues

Analysing issue reports can be a lot of effort. Any help is welcome!
Go to [the GitHub issue tracker](https://github.com/openflighthpc/concertim-ct-visualisation-app/issues?state=open)
...
If you find a bug - behaviour of Concertim Visualisation App code or documentation
...
[GitHub issue tracker for OpenFlight Concertim Visualisation App](https://github.com/openflighthpc/concertim-ct-visualisation-app/issues/new)
to report the issue.
...
We want to improve the quality of OpenFlight Concertim Visualisation App and good bug reports are
...
Concertim Visualisation App is Open Source and comes without warranty.
...
Concertim Visualisation App in order to fix bugs or to implement new features.
...
2. **Not all proposed contributions can be accepted**. Some features
   ...
   the overall direction of Concertim Visualisation App and really improve it. The more
...
applied to Concertim Visualisation App itself.

In particular you need to agree to the Contributor License Agreement,
which can be [found
here](https://www.clahub.com/agreements/openflighthpc/concertim-ct-visualisation-app). This
...
8. Wait for our code review and approval, possibly enhancing your
   change on request.
    - Note that the Concertim Visualisation App developers also have their regular
...
1. Create a topic branch from where you want to base your work.
    ...
    * Only target release branches if you are certain your fix must be
      on that branch.
    * To quickly create a topic branch based on main, run `git
      checkout -b fix/main/my_contribution main`. Please avoid
