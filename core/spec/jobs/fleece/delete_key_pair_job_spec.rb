...
RSpec.describe Fleece::DeleteKeyPairJob, type: :job do
  ...
  subject { Fleece::DeleteKeyPairJob::Runner.new(key_pair_name: "my_lovely_key_pair", fleece_config: config, user: user) }
